...
class BayesianCostLayerProcessor(Node):
    ...
    def path_status_callback(self, msg):
        ...
        # Convert probabilities to binary using 0.56 threshold (same as infer_vis.py)
        threshold = 0.56
        ...
        self.get_logger().info(f'🎯 Paths: F={front_open}, L={left_open}, R={right_open} | '
        ...
        # Create recovery point marker if 2+ paths are open
